...
function Controller() {
    ...
    $.__views.overlay.add($.__views.titleView);
    ...
    $.title = CONFIG.image ? Ti.UI.createImageView({
        image: CONFIG.image,
        height: "26dp",
        width: Ti.UI.SIZE,
        top: "10dp",
    ...
    $.setBackgroundColor = function(_color, _theme) {
        ...
        theme = _theme ? _theme : 65 > hexToHsb(_color).b ? "white" : "black";
    };
